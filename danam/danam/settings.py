...
ETL_MODULE_LOCATIONS.append('danam.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('danam.search_components')
...
SECRET_KEY = '#fhm5far&urep6@16kitm+(9o=v((pc2cf-dss(vvu_qda*%wy'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'danam.urls'
...
# [{
#     'module': 'danam.search_indexes.sample_index.SampleIndex',
